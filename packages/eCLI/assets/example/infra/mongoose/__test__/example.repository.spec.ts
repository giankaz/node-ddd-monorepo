...
describe('mongoose repository tests', () => {
  ...
  it('should run the method search using filters', async () => {
    ...
    const filter: FilterParams<ExampleRepositoryInterface.ExampleFields>[] = [
      {
        column: 'name',
    ...
    const filter2: FilterParams<ExampleRepositoryInterface.ExampleFields>[] = [
      {
        column: 'name',
        operator: FilterOperators.CONTAINS,
        type: 'string',
    ...
    const filter3: FilterParams<ExampleRepositoryInterface.ExampleFields>[] = [
      {
        column: 'id',
