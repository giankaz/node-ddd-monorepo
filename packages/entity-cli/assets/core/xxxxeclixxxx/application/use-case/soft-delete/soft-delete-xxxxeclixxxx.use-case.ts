...
export namespace SoftDeleteXxxxeclixxxxUseCase {
  export type Input = {
    id: string;
  };
  ...
  export class UseCase extends DefaultUseCase<Input, Output> {
    context = 'Soft Delete Xxxxeclixxxx Use Case';
    ...
    public async useCase(
      ...
      const xxxxeclixxxx = await this.xxxxeclixxxxRepository.softDelete(
        input.id,
      );
