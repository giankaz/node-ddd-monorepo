...
import { ImportationInMemoryRepository } from '../';

describe('Importation In Memory Repository Tests', () => {
  let repository: InMemoryRepository<
    ImportationModel,
    Importation,
    ImportationRepositoryInterface.ImportationFields
  >;
  beforeEach(() => (repository = new ImportationInMemoryRepository()));
  ...
  it('should updates an entity', async () => {
    ...
    const entityUpdated = RandomImportationFactory.createOne({
      id: entity.id,
    });
