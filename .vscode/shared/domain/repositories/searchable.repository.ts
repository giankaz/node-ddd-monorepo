...
export interface RepositoryInterface<Model, E extends Entity<Model>> {
  insert(entity: E): Promise<E>;
  insertMany(entities: E[]): Promise<E[]>;
  findById(id: string): Promise<E>;
  findByField(field: keyof Model, value: unknown): Promise<E>;
  findAll(): Promise<E[]>;
  search(props: SearchParams): Promise<SearchResult<Model, E>>;
...
type SearchResultProps<Model, E extends Entity<Model>> = {
  items: E[];
  total: number;
  current_page: number;
  per_page: number;
...
export class SearchResult<Model, E extends Entity<Model>> {
  readonly items: E[];
  ...
  constructor(props: SearchResultProps<Model, E>) {
